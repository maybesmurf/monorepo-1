...
export const Box = (props: SVGProps<SVGSVGElement>) => {
	return (
		<svg width={props.width || "100%"} height={props.height || "auto"} viewBox="0 0 18 19" {...props}>
			<path
			...
			<path
				...
				strokeLinejoin="round"
			/>
			<path d="M9 17.06V9.5" stroke={props.stroke || "currentColor"} strokeLinecap="round" strokeLinejoin="round" />
		</svg>
	)
}
