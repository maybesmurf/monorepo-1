...
export const Table = ({ headers, rows, horizontalSpacing = "xs", verticalSpacing = "xs", ...props }: Props) => {
	const { colors } = useMantineTheme()

	return (
		<MantineTable horizontalSpacing={horizontalSpacing} verticalSpacing={verticalSpacing} {...props}>
			<thead>
				<tr>
					{headers.map((header) => {
						return (
